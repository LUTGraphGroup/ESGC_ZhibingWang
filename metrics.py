...
class Metrictor:
    def __init__(self, classNum):
        ...
        self._reporter_ = {"MaF": self.MaF, "MiF": self.MiF, "MiP": self.MiP, "MiR": self.MiR, "skMiF": self.skMiF,
                           "MiF@50": self.MiF50, "MiF@100": self.MiF100, "MiF@150": self.MiF150, "MiF@200": self.MiF200,
                           "MiF@250": self.MiF250, "MiF@300": self.MiF300, "MiF@350": self.MiF350,
                           "MiF@400": self.MiF400, "MiF@450": self.MiF450, "MiF@500": self.MiF500,
                           "MiF@1000": self.MiF1000, "P@8": self.P8, "P@5": self.P5, "P@15": self.P15, "R@10": self.R10,
                           "R@50": self.R50, "R@100": self.R100, "R@450": self.R450, "R@80": self.R80,
                           "R@100": self.R100, "R@500": self.R500, "R@1000": self.R1000, "ACC": self.ACC,
                           "LOSS": self.LOSS, "MaAUC": self.MaAUC, "MiAUC": self.MiAUC, "MaMCC": self.MaMCC,
                           "MiMCC": self.MiMCC}
